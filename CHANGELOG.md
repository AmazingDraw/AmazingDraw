...
- 优化多人场景解剖门禁与防穿模机制；重构部分场景表现力与物理支撑；优化通知卡片交互链接

## 0.1.15 — 2026-09-17

- 扩充角色写真 LoRA 资源并优化场景库；支持配置自定义明星禁用名单；优化启动环境探测与文档排版

## 0.1.14 — 2026-09-14

- 安装引导与交互体验优化（支持 --help、常见 Python 路径嗅探与拖拽文件夹引号处理，进阶设置回车跳过）；更新推荐模型与 Agent 支持；同步最新场景库与互斥门禁规则。
